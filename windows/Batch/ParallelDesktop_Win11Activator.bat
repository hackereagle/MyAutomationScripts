REM This is refer to https://www.guidingtech.com/how-to-activate-windows-11-for-free/
@echo off

echo Please ensure you run this batch with administrator authority!
...
REM explorer "http://MSGuides.com"&goto halt
